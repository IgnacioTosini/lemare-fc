...
export const PlayerInfoForm = ({ formData, handleChange, setFormData }: { formData: Player, handleChange: (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => void, setFormData: React.Dispatch<React.SetStateAction<Player>> }) => {
    ...
    return (
        <section className="playerInfoForm">
            ...
            <label>
                País
                <input type="text" name="country" value={formData.country || ''} onChange={handleChange} placeholder='Argentina' />
